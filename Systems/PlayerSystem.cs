  ...
  public override void Update(GameTime gameTime)
  {
    ...
    foreach (var entity in ActiveEntities)
    {
      ...
      if (Keyboard.GetState().IsKeyDown(Keys.X) && _bulletTimer.IsExpired)
      {
        ...
        var shockwaveColor = new Color(Pico8Color.Color9.R, Pico8Color.Color9.G, Pico8Color.Color9.B, Pico8Color.Color9.A);
        ...
        ExplosionFactory.CreateExplosion(
          ...
          () => new Particle(
            age: 0,
            maxAge: 0,
            color: new Color(Pico8Color.Color7.R, Pico8Color.Color7.G, Pico8Color.Color7.B, Pico8Color.Color7.A),
            isBlue: false,
            radius: 10,
            shape: Shape.Circle,
            spark: false
