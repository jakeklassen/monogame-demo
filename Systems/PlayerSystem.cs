...
namespace Systems
{
	...
	{
		private readonly QueryDescription _playerEntities = new QueryDescription().WithAll<Direction, TagPlayer, Transform>();
		...
		public override void Update(in GameTime gameTime)
		{
			...
			World.Query(in _playerEntities, (in Entity entity) =>
			{
